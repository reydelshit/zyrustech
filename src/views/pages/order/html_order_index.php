                    ...
                    <tr>
                        ...
                        <td><?= ucfirst($order->get_type()->value) ?>
                            <?php if ($order->get_type() === OrderType::Online && $order->get_payment_status() === PaymentStatus::Complete) : ?>
                                <small class="text-muted"><br>40 + Free Shipping</small>
                            <?php endif; ?>
                            <?php if ($order->get_type() === OrderType::Delivery && $order->get_payment_status() === PaymentStatus::Complete) : ?>
                                <small class="text-muted text-wrap"><br>40 Cashbacks.</small>
                            <?php endif; ?>
                        </td>
                    </tr>
                ...
                <table class="table">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td colspan="2" class="fw-bold">PHP <?= $order->get_amount()  ?></td>
                        </tr>
                    </tfoot>
                </table>
            <?php else : ?>
