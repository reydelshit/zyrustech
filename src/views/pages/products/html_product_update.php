    ...
    <div class="row mt-5">
        <div class="col-lg-6">
            ...
            <form class="mt-4" action="<?= build_route("product-update") ?>" method="POST">
                ...
                <div class="mb-4">
                    <label for="productPrice" class="form-label">Price (PHP)<span class="text-danger">*</span></label>
        ...
        <div class="col-lg-6 align-items-center d-flex">
            <div class="card mx-auto border-0 shadow" style="width: 20rem;">
                ...
                <div class="card-body">
                    ...
                    <p id="productPriceText" class="card-text fw-bold">PHP <?= $product->get_price() ?></p>
                    <div class="row justify-content-between">
...
<script>
    ...
    document.getElementById("productPrice").addEventListener("input", (event) => {
        document.getElementById("productPriceText").innerText = `PHP ${event.target.value}`;
    });
</script>
