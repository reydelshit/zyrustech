...
class OrderController extends BaseController
{
    ...
    public function show_sales_report(array $request)
    {
        // Retrieve sales report data and perform necessary calculations

        // Render the sales report view
        $this->render('views/pages/order/html_sales_report', ["title" => "Sales Report", /* pass data to the view */]);
    }
}
